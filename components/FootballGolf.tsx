          ...
          <div style={{flex:7,minWidth:0,display:'flex',flexDirection:'column',padding:'0 0 20px'}}>
            ...
            <div style={{flex:1,minHeight:0,marginTop:22}}>
              <CourseView
                ...
                imageUrl={courseMode==='real' ? (selectedCourse==='augusta' ? `/holes/augusta/hole_${String(currentHole.number).padStart(2,'0')}.png?v=6` : `/holes/hole_${String(currentHole.number).padStart(2,'0')}.png`) : undefined}
