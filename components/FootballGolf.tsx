                ...
                <div style={{display:'flex',gap:8,flexShrink:0}}>
                  <div style={boxStyle}>
                    ...
                    <div style={{flex:1,display:'flex',alignItems:'center',justifyContent:'center',width:'100%'}}>
                      <div style={{fontSize:11,fontWeight:800,color:'white',lineHeight:1.2,textAlign:'center'}}>{question.statLabel}</div>
                    </div>
                  </div>
                  <div style={boxStyle}>
                    <div style={labelStyle}>Filter</div>
                    <div style={{flex:1,display:'flex',alignItems:'center',justifyContent:'center',width:'100%'}}>
                      <div style={{fontSize:11,fontWeight:600,color:'white',lineHeight:1.2,textAlign:'center'}}>{filterText}</div>
                    </div>
                  </div>
                </div>
              )
