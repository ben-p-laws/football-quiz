...
export async function GET() {
  return new ImageResponse(
    (
      <div style={{ width: 1200, height: 630, background: '#0a0f1e', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', fontFamily: 'system-ui, sans-serif' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'baseline', gap: 20 }}>
          <div style={{ display: 'flex', fontSize: 140, fontWeight: 900, color: 'white', lineHeight: 1, letterSpacing: '-6px' }}>Perfect</div>
          <div style={{ display: 'flex', fontSize: 140, fontWeight: 900, color: '#dc2626', lineHeight: 1, letterSpacing: '-6px' }}>10</div>
        </div>
