...
export const FIFA_TO_ISO: Record<string, number> = {
  ...
  BLR: 112, LTU: 440, LVA: 428, EST: 233, MDA: 498, ISL: 352,
  // Africa
  ...
  SDN: 729, SSD: 728, ETH: 231, KEN: 404, TAN: 834,
  UGA: 800, NAM: 516, BOT:  72, CHA: 148, NIG: 562,
  SOM: 706, MWI: 454, ERI: 232, MAD: 450, LES: 426,
  SWZ: 748, DJI: 262,
  // South America
  ...
  IND: 356, PAK: 586, BAN:  50, KSA: 682, UAE: 784,
  OMA: 512, KUW: 414, QAT: 634, BHR:  48, YEM: 887,
  AFG:   4, KAZ: 398, UZB: 860, TKM: 795, KGZ: 417,
  TJK: 762, GEO: 268, ARM:  51, AZE:  31, NEP: 524,
  SRI: 144, MYA: 104, THA: 764, VIE: 704, CAM: 116,
  LAO: 418, MAS: 458, INA: 360, PHI: 608, MNG: 496,
  PRK: 408, BHU:  64, TLS: 626,
  // Russia/Eurasia
  RUS: 643,
}
...
export const COUNTRY_NAMES: Record<string, string> = {
  ...
  GAB: 'Gabon',        COD: 'DR Congo',     COG: 'Congo',        ZIM: 'Zimbabwe',
  ZAF: 'South Africa', ZAM: 'Zambia',       ANG: 'Angola',       MOZ: 'Mozambique',
  MLI: 'Mali',         MTN: 'Mauritania',   BFA: 'Burkina Faso', SLE: 'Sierra Leone',
  LBR: 'Liberia',      GAM: 'Gambia',       GNB: 'Guinea-Bissau',EQG: 'Eq. Guinea',
  RWA: 'Rwanda',
  SDN: 'Sudan',        SSD: 'S. Sudan',     ETH: 'Ethiopia',     KEN: 'Kenya',
  TAN: 'Tanzania',     UGA: 'Uganda',       NAM: 'Namibia',      BOT: 'Botswana',
  CHA: 'Chad',         NIG: 'Niger',        SOM: 'Somalia',      MWI: 'Malawi',
  ERI: 'Eritrea',      MAD: 'Madagascar',   LES: 'Lesotho',      SWZ: 'Eswatini',
  DJI: 'Djibouti',
  ...
  IND: 'India',        PAK: 'Pakistan',     BAN: 'Bangladesh',   KSA: 'Saudi Arabia',
  UAE: 'UAE',          OMA: 'Oman',         KUW: 'Kuwait',       QAT: 'Qatar',
  BHR: 'Bahrain',      YEM: 'Yemen',        AFG: 'Afghanistan',  KAZ: 'Kazakhstan',
  UZB: 'Uzbekistan',   TKM: 'Turkmenistan', KGZ: 'Kyrgyzstan',   TJK: 'Tajikistan',
  GEO: 'Georgia',      ARM: 'Armenia',      AZE: 'Azerbaijan',   NEP: 'Nepal',
  SRI: 'Sri Lanka',    MYA: 'Myanmar',      THA: 'Thailand',     VIE: 'Vietnam',
  CAM: 'Cambodia',     LAO: 'Laos',         MAS: 'Malaysia',     INA: 'Indonesia',
  PHI: 'Philippines',  MNG: 'Mongolia',     PRK: 'North Korea',  BHU: 'Bhutan',
  TLS: 'Timor-Leste',
  BLR: 'Belarus',      LTU: 'Lithuania',    LVA: 'Latvia',       EST: 'Estonia',
  MDA: 'Moldova',      ISL: 'Iceland',
  RUS: 'Russia',
}
